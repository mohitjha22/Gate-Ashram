...
@Component({
  ...
  styleUrls: ['./subjecttest.component.css']
})
export class SubjecttestComponent implements OnInit {
  ...
  constructor(
    private _subjecttestService: SubjecttestService,
  ...
  ngOnInit() {
    ...
    this._subjecttestService.getTestQuestions(this.subject).
      subscribe((data) => {
        this.questions = data;
        //console.log(data);
  ...
  submitTest() {
    ...
    var correct2 = 0;
    var score = 0;
    var heading = "Subjectwise Test-" + this.subject;
